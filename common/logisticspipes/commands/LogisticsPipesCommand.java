...
public class LogisticsPipesCommand extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] arguments) {
		...
		if(arguments[0].equalsIgnoreCase("version")) {
        	...
        	sender.sendChatToPlayer(ChatMessageComponent.func_111066_d("- transfernames : Sends all item names form the client to the server to update the Language Database."));
        	return;
