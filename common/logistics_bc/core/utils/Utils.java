...
import logistics_bc.core.TileBuildCraft;
...
public class Utils {
	...
	public static void handleBufferedDescription(ISynchronizedTile tileSynch) {
		...
		if (lp_BuildCraftCore.bufferedDescriptions.containsKey(index)) {

			PacketUpdate payload = lp_BuildCraftCore.bufferedDescriptions.get(index);
			lp_BuildCraftCore.bufferedDescriptions.remove(index);
